...
import { getPatrimonioComparacion, syncPatrimonioHistorial } from "@/lib/patrimonio";
...
export async function GET() {
  try {
    ...
    return NextResponse.json({ activos, historial, comparacion });
  } catch (error) {
    console.error("Error fetching activos:", error);
    return NextResponse.json({ activos: [], historial: [], comparacion: null });
  }
}
